...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i, hd in enumerate(hidden_dims):
            self.params[f'W{i+1}'] = np.random.normal(0, weight_scale, (layer_input_dim, hd))
    ...
    def loss(self, X, y=None):
        ...
        # Backward pass
        grads = {}
        dout, grads[f'W{self.num_layers}'], grads[f'b{self.num_layers}'] = affine_backward(dscores, final_cache)
